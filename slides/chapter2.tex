...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c2.team.01.png}\\
    三个人干活，五个人看，还有俩个在捣蛋。
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \begin{block}{实验}
    在以拒绝亚裔人士出名的小城里，和中国人一路旅行（65/66旅店），旅行结束后进行问卷调查。（实验组1/128问卷 vs. 对照组）
  \end{block}
  \vspace{-0.5em}
  \pause
  \begin{block}{结果结论}
...
\begin{frame}
  ...
  \begin{block}{结论}
    \begin{itemize}
      ...
      \item \alert{验证性偏见}：一旦一个人被认为有精神疾病，那么他的所有行为都会被放在这一前提下对待，精神病院的医务人员会忽视或者误解他的正常行为。
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.52\textwidth]{c2.sale.01.png}
  \end{figure}
  \vspace{-0.8em}
  \pause
  \begin{block}{拍卖规则}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<1->{\includegraphics[width=0.5\textwidth]{c2.ig.01.png}}\qquad
    \visible<2->{\includegraphics[width=0.23\textwidth]{c2.bear.01.jpg}}\\
    \vspace{1em}
    \visible<3->{\includegraphics[width=0.35\textwidth]{c2.laugh.01.jpg}}\qquad
    \visible<3->{\includegraphics[width=0.3\textwidth]{c2.laugh.02.jpg}}\\
