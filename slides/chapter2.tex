...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c2_test_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{c2_ringelmann_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{c2_team_01.png}\\
    三个人干活，五个人看，还有俩个在捣蛋。
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{c2_asch_01.png}
  \end{figure}
\end{frame}
...
\begin{figure}
  \centering
  \includegraphics[width=0.35\textwidth]{c2_horse_01.jpg}\quad
  \includegraphics[width=0.36\textwidth]{c2_horse_02.jpg}\\
  \includegraphics[width=0.4\textwidth]{c2_horse_03.jpg}
\end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.3\textwidth]{c2_book_01.jpg}
  \end{figure}
  本书作者对“动物能够思考吗?”、“它们有情感吗?”、“它们对自己是否有所了解?”等问题进行了研究；讲述了许多令人难以置信的动物行为，并根据来自生物学、动物学以及行为研究的最新认识对其进行了审视。
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{c2_prisoner_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  \frametitle{破窗理论 | 深入研究 | 实验三 | 无关紧要规则}
  \begin{block}{疑问}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{c2_bridge_01.jpg}
    \visible<2->{\includegraphics[width=0.55\textwidth]{c2_bridge_02.jpg}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{四卡问题}
    \begin{figure}
      \centering
      \includegraphics[width=0.9\textwidth]{c2_cards_01.png}
    \end{figure}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{c2_smoke_01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \end{block}
  \pause
  \begin{block}{启示（实例：选课 vs. 抢课；社团纳新；恋爱）}
    \begin{itemize}
...
\begin{frame}
  ...
  \end{block}
  \pause
  \begin{block}{生活实例：为什么我们总是很难说服别人？}
    \begin{itemize}
      \item 你越是和那些伪科学拥趸讲科学，他们越觉得你是欲盖弥彰。
      \item 你越是和愤青讲理性，他们越觉得你是卖国贼。
...
\begin{frame}
  ...
  \begin{block}{问卷调查}
    在分析问卷的过程中，科学家们默认问卷上的回答和人们日常生活的行为是一致的。\alert{（这种假设正确吗？）}
  \end{block}
  \vspace{-0.5em}
  \pause
  \begin{block}{实验}
...
\begin{frame}
  ...
  \begin{block}{2个问题}
    \begin{itemize}
      % \item 独立的个体平均认识他人的数量是多少？（100天内传递书 $\longrightarrow$ 平均一个人认识500个人）
  ...
  \begin{block}{暂时的结论}
    \begin{itemize}
      % \item （上述例子）并非每增高一层就增加10倍的人，而是明显要少于这个数。（团体开放程度、团体如何连接）
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.52\textwidth]{c2_sale_01.png}
  \end{figure}
  \vspace{-0.8em}
  \pause
  \begin{block}{拍卖规则}
...
为什么如今公交车或者地铁里的年轻人都不给白发苍苍的老妇人让座了？（不成文的规定：别去直接索要别人的座位！）
  ...
  \begin{block}{实验}
    \begin{itemize}
      \item “...，我站着没法看书。”（1/3）；高声谈论请求别人让座后再去请求让座（1/3）
      \item “不好意思，能把座位让给我吗？”（2/3）；先说“不好意思”，然后递纸条请求让座（半数以上）
    \end{itemize}
  \end{block}
  \vspace{-0.5em}
  \pause
...
\begin{frame}
  ...
  \end{block}
  \pause
  \begin{block}{\alert{邓宁-克鲁格效应（2000年搞笑诺贝尔奖）}}
    \begin{itemize}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.65\textwidth]{c2_dk_01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{c2_dk_02.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<1->{\includegraphics[width=0.5\textwidth]{c2_ig_01.png}}\qquad
    \visible<2->{\includegraphics[width=0.23\textwidth]{c2_bear_01.jpg}}\\
    \vspace{1em}
    \visible<3->{\includegraphics[width=0.35\textwidth]{c2_laugh_01.jpg}}\qquad
    \visible<3->{\includegraphics[width=0.3\textwidth]{c2_laugh_02.jpg}}\\
    \visible<3->{爱笑/犯二的男生/女生运气不会差！}
  \end{figure}
\end{frame}
