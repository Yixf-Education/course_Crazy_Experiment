...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item 为了排除各种不必要的干扰，人们应尽可能将被试者分成相似的小组，再对他们实施不同的治疗。
    \item 药物测试必须在“双盲”的前提下进行：病人和医生只有在研究结束后才能知道他们使用的是哪种药物。（防止人们由于事先了解某种药物而产生妨碍实验准确性的心理暗示。）
  \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{真正的疯狂}
    \begin{itemize}
      % 1-37,1889
    \item 返老还童——查尔斯 $\textbullet$ 布朗，注射过滤后的浆液（捣碎的睾丸+蒸馏水），安慰剂效应、荷尔蒙疗法的先驱
      % 1-47,1899
