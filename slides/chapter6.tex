...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{c6.Reagan.01.jpg}\quad
    \includegraphics[width=0.33\textwidth]{c6.Reagan.02.jpg}
  \end{figure}
  \pause
  \begin{block}{里根}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c6.ai.01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \pause
  \begin{block}{结果}
留胡子：不够有目标、不够专心、不够友善、不够坚强、不够理智、不够聪明……；看起来不拘束、比较随意、比较有发展势头……
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{c6.eye.01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{结果}
    \begin{itemize}
      ...
      \item 填写问卷的过程张，惶恐情绪体现得最为明显，尤其是在回忆安全指令时，很多人忘记了近乎一半的内容。
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{c6.face.01.png}
  \end{figure}
  \end{block}
\end{frame}
