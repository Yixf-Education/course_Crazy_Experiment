...
\begin{frame}
  ...
  \begin{block}{科学问题}
    ...
    \begin{figure}
      \centering
      \includegraphics[width=0.9\textwidth]{c1.rainbow.01.jpg}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{迪特里希的实验}
    \begin{itemize}
      ...
      \item 结论：彩虹是由一类特殊的不断下落的镜子——雨滴所组成，它们前后相继接连不断地闪现彩虹的各种颜色。因为一直有雨滴持续落下，所以才会造成一个静止不动额颜色带的印象。
...
\begin{frame}
  ...
  \begin{block}{多普勒效应的应用}
    \begin{itemize}
      \item 巴洛特的预见：唯一的可能就是“没准儿以后会造出更好地乐器来”
...
\begin{frame}
  ...
  \begin{block}{生物学——细胞膜}
    \begin{itemize}
      \item 现象：某些物质在对细胞膜的穿透性与它们在橄榄油中的溶解性有着独特的关联
...
\begin{frame}
  ...
  \begin{block}{刮擦黑板声的听觉效应}
    \begin{itemize}
      ...
      \item 结果：有时知情组被试者的皮肤电阻更高，有时缺失不知情组的数值更高
    \end{itemize}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{一把园艺镰刀在石板上的缓慢刮擦}
    \begin{itemize}
      \item 实验1：24名被试者，16中声音，记录被试者的评价，筛选出得分最差的声音
